...
export default function GetInTouchPage() {
        ...
        <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div data-aos="fade-right" className="text-white space-y-6 max-md:mt-20">
            ...
            <p className="text-lg text-gray-200 leading-relaxed max-w-md">
              Connect with <span className="font-semibold text-[#2cb9ff]">BeaverHealthAI</span> for partnerships, support,
              and innovative healthcare solutions that redefine patient care.
            </p>
  ...
  <li>📍 Chennai, India</li>
          ...
          >
            ...
            {submitted && (
              <div className="mb-6 text-center text-lg bg-green-100/80 px-4 py-3 rounded-lg border border-green-300 text-green-800 font-semibold">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              {/* Mobile */}
              <div>
                <label className="block mb-1 font-medium text-white">Mobile Number</label>
                <input
                  {...register('mobile', {
                    required: true,
                    pattern: /^[0-9]{10}$/,
